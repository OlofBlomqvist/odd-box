...
// LEGACY ---> V1
impl TryFrom<crate::configuration::legacy::OddBoxLegacyConfig>
    for crate::configuration::v1::OddBoxV1Config
{
    type Error = String;

    fn try_from(
        old_config: crate::configuration::legacy::OddBoxLegacyConfig,
        ...
        let new_config = crate::configuration::v1::OddBoxV1Config {
            ...
            hosted_process: Some(
                old_config
                    .processes
                    .into_iter()
                    .map(|x| crate::configuration::v1::InProcessSiteConfig {
                        forward_subdomains: None,
